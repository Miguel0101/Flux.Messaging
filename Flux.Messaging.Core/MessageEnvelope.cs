...
internal sealed class MessageEnvelope : IMessageEnvelope
{
    ...
    public static MessageEnvelope CreateRequest(object payload, string replyTo)
    {
        return new(payload, null, replyTo);
    }

    public static MessageEnvelope CreateResponse(object payload, string correlationId)
    {
        return new(payload, correlationId, null);
    }
}